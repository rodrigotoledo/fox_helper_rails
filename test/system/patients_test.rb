...
class PatientsTest < ApplicationSystemTestCase
  ...
  test "should create patient" do
    ...
    fill_in "Emergency type", with: @patient.emergency_type
    fill_in "Name", with: @patient.name
    fill_in "Phone", with: @patient.phone
    fill_in "Responsible", with: @patient.responsible
    fill_in "Responsible phone", with: @patient.responsible_phone
